import type { Plugin, Hooks, ToolContext } from "@opencode-ai/plugin";
...
const scratchpadPlugin: Plugin = async (input) => {
  const hooks: Hooks = {
...
Use session_scratch_read to load specific files.`
    ...
    tool: {
      ...
      session_scratch_read: tool({
        description:
          "Read content from a file in the session scratch space",
        args: {
